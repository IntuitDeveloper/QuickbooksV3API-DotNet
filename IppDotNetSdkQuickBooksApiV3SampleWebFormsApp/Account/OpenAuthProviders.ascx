<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="IppDotNetSdkQuickBooksApiV3SampleWebFormsApp.Account.OpenAuthProviders" %>
